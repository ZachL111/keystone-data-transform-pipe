"""Regression checks for the keystone-data-transform-pipe casebook."""
...
from casebook.harness import assert_expected, keystone_data_transform_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(keystone_data_transform_pipe_summary(), assert_expected())
